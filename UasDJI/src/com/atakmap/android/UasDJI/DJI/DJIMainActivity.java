...
public class DJIMainActivity extends Activity implements SurfaceTextureListener,OnClickListener{
...
//        }
        ...
        DJICamera camera = DJIBackgroundApp.getCameraInstance();
...
//        recordingTime.setVisibility(View.INVISIBLE);
    ...
    private void uninitPreviewer() {
        ...
        if (camera != null){
            // Reset the callback
            DJIBackgroundApp.getCameraInstance().setDJICameraReceivedVideoDataCallback(null);
        }
    }
    ...
    public void showToast(final String msg) {
        runOnUiThread(new Runnable() {
            public void run() {
                Toast.makeText(DJIMainActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void captureAction(){
        ...
        final DJICamera camera = DJIBackgroundApp.getCameraInstance();
        if (camera != null) {
